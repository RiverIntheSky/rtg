...
/// ============= STUDENT CODE BEGIN =============
    ...
    float aoAt(glm::ivec3 pos) const;

    //void addQuad(std::vector<TerrainVertex> vertices, glm::ivec3 gp, glm::ivec3 p, glm::ivec3 normal);

    //void addTriangle(std::vector<TerrainVertex> vertices, glm::ivec3 gp, int a, int b, int c);
