...
SharedElementArrayBuffer ElementArrayBuffer::create(size_t indexCount, const int8_t *data)
{
    auto eab = create();
...
SharedElementArrayBuffer ElementArrayBuffer::create(size_t indexCount, const uint8_t *data)
{
    auto eab = create();
    eab->bind().setIndices(indexCount, data);
    return eab;
...
SharedElementArrayBuffer ElementArrayBuffer::create(size_t indexCount, const int16_t *data)
{
    auto eab = create();
    eab->bind().setIndices(indexCount, data);
    return eab;
...
SharedElementArrayBuffer ElementArrayBuffer::create(size_t indexCount, const uint16_t *data)
{
    auto eab = create();
    eab->bind().setIndices(indexCount, data);
    return eab;
...
SharedElementArrayBuffer ElementArrayBuffer::create(size_t indexCount, const int32_t *data)
{
    auto eab = create();
    eab->bind().setIndices(indexCount, data);
    return eab;
...
SharedElementArrayBuffer ElementArrayBuffer::create(size_t indexCount, const uint32_t *data)
{
    auto eab = create();
    eab->bind().setIndices(indexCount, data);
    return eab;
...
{
    GLOW_RUNTIME_ASSERT(sCurrentBuffer == this, "Currently bound EAB does NOT match represented buffer", return false);
    return true;
}
...
void ElementArrayBuffer::BoundElementArrayBuffer::setIndices(size_t indexCount, const int8_t *data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_BYTE, data, usage);
}

void ElementArrayBuffer::BoundElementArrayBuffer::setIndices(size_t indexCount, const uint8_t *data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_BYTE, data, usage);
}

void ElementArrayBuffer::BoundElementArrayBuffer::setIndices(size_t indexCount, const int16_t *data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_SHORT, data, usage);
}

void ElementArrayBuffer::BoundElementArrayBuffer::setIndices(size_t indexCount, const uint16_t *data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_SHORT, data, usage);
}

void ElementArrayBuffer::BoundElementArrayBuffer::setIndices(size_t indexCount, const int32_t *data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_INT, data, usage);
}

void ElementArrayBuffer::BoundElementArrayBuffer::setIndices(size_t indexCount, const uint32_t *data, GLenum usage)
{
    setIndices(indexCount, GL_UNSIGNED_INT, data, usage);
}

void ElementArrayBuffer::BoundElementArrayBuffer::setIndices(size_t indexCount, GLenum indexType, const void *data, GLenum usage)
{
    if (!isCurrent())
        return;
...
ElementArrayBuffer::BoundElementArrayBuffer::BoundElementArrayBuffer(ElementArrayBuffer *buffer) : buffer(buffer)
{
    GLOW_RUNTIME_ASSERT(VertexArray::getCurrentVAO() == nullptr,
                        "Cannot bind an EAB while a VAO is bound! (this has unintended side-effects in OpenGL)", return );
