...
public:
    ...
    struct BoundElementArrayBuffer
    {
        ...
        void setIndices(size_t indexCount, const int8_t* data = nullptr, GLenum usage = GL_STATIC_DRAW);
        void setIndices(size_t indexCount, const uint8_t* data = nullptr, GLenum usage = GL_STATIC_DRAW);
        void setIndices(size_t indexCount, const int16_t* data = nullptr, GLenum usage = GL_STATIC_DRAW);
        void setIndices(size_t indexCount, const uint16_t* data = nullptr, GLenum usage = GL_STATIC_DRAW);
        void setIndices(size_t indexCount, const int32_t* data = nullptr, GLenum usage = GL_STATIC_DRAW);
        void setIndices(size_t indexCount, const uint32_t* data = nullptr, GLenum usage = GL_STATIC_DRAW);
        void setIndices(size_t indexCount, GLenum indexType, const void* data = nullptr, GLenum usage = GL_STATIC_DRAW);
        template <typename IndexT, size_t N>
        void setIndices(const IndexT(&data)[N], GLenum usage = GL_STATIC_DRAW)
        {
            setIndices(N, data, usage);
        }
...
public: // static construction
    ...
    static SharedElementArrayBuffer create(size_t indexCount, const int8_t* data);
    static SharedElementArrayBuffer create(size_t indexCount, const uint8_t* data);
    static SharedElementArrayBuffer create(size_t indexCount, const int16_t* data);
    static SharedElementArrayBuffer create(size_t indexCount, const uint16_t* data);
    static SharedElementArrayBuffer create(size_t indexCount, const int32_t* data);
    static SharedElementArrayBuffer create(size_t indexCount, const uint32_t* data);
    ...
    /// CAUTION: Cannot be used while a VAO is bound! (runtime error)
    static SharedElementArrayBuffer create(size_t indexCount, GLenum indexType, const void* data = nullptr);
};
}
