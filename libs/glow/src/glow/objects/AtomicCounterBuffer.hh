...
public:
    ...
    struct BoundAtomicCounterBuffer
    {
        ...
        void setCounters(uint32_t value, size_t count = 1, GLenum usage = GL_STATIC_DRAW);

        /// Returns the value of a counter at the given position
        uint32_t getCounter(size_t pos = 0);
...
public: // static construction
    ...
    static SharedAtomicCounterBuffer create(uint32_t value = 0, size_t count = 1);
